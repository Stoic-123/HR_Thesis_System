          ...
          <FlatList
            ...
            ListHeaderComponent={
              <View>
                ...
                >
                  <Pressable style={{ padding: 4 }} className="active:opacity-60">
                    <MaterialIcons name="chevron-left" size={22} color={isDark ? '#FFFFFF' : '#111827'} />
                  </Pressable>
                  <Text style={{ fontSize: 14, fontWeight: '700', color: isDark ? COLORS.dark.text : COLORS.light.text }}>
                    {currentMonth}
                  </Text>
                  <Pressable style={{ padding: 4 }} className="active:opacity-60">
                    <MaterialIcons name="chevron-right" size={22} color={isDark ? '#FFFFFF' : '#111827'} />
                  </Pressable>
                </View>
